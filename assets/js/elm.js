...
var _user$project$Model$questionDescription = function (record) {
	return A2(
		...
		_elm_lang$core$List$head(
			A2(_elm_lang$core$List$take, 1, record.text)));
};
var _user$project$Model$QuestionRecord = F8(
...
var _user$project$Model$SubHeading = {ctor: 'SubHeading'};
var _user$project$Model$Table = {ctor: 'Table'};
var _user$project$Model$Button = {ctor: 'Button'};
var _user$project$Model$TextArea = {ctor: 'TextArea'};
var _user$project$Model$TextBox = {ctor: 'TextBox'};
var _user$project$Model$EditBox = {ctor: 'EditBox'};
var _user$project$Model$RadioButton = {ctor: 'RadioButton'};
...
var _user$project$Model$StartEdit = function (a) {
	return {ctor: 'StartEdit', _0: a};
};
var _user$project$Model$RmQuestion = function (a) {
	return {ctor: 'RmQuestion', _0: a};
};
var _user$project$Model$AddQuestionBelow = F2(
	function (a, b) {
		return {ctor: 'AddQuestionBelow', _0: a, _1: b};
	});
var _user$project$Model$AddQuestion = function (a) {
...
var _user$project$Model$initialModel = {
	...
	questionList: {
		...
		_0: A8(
			...
			{
				ctor: '::',
				_0: 'Choose from the follwing list:',
				_1: {ctor: '[]'}
			},
			_user$project$Model$DropDown,
			_user$project$Model$None,
			{
				ctor: '::',
				_0: 'NONE|Please select one:',
				_1: {
					ctor: '::',
					_0: 'RNGR|Ranger',
					_1: {
		...
		_1: {
			...
			_0: A8(
				...
				'The Ranger',
				{
					...
					_1: {
						ctor: '::',
						_0: _user$project$Model$rangerMarkdownText,
						_1: {ctor: '[]'}
					}
				},
				_user$project$Model$Markdown,
				_user$project$Model$None,
				{ctor: '[]'},
				{ctor: '[]'},
				{ctor: '[]'}),
			_1: {
				...
				_0: A8(
					...
					{
						ctor: '::',
						_0: '_ranger image from devianart_',
						_1: {
							ctor: '::',
							_0: _user$project$Model$rangerMarkdownImage,
							_1: {ctor: '[]'}
						}
					},
					_user$project$Model$Markdown,
				...
				_1: {
					...
					_0: A8(
						...
						{
							ctor: '::',
							_0: A2(_elm_lang$core$Basics_ops['++'], '__Fighter__', _user$project$Model$fighterMarkdownText),
							_1: {ctor: '[]'}
						},
						_user$project$Model$Markdown,
						_user$project$Model$None,
								...
								_1: {
									...
									_0: A8(
										...
										},
										{
											...
											_0: {
												ctor: '::',
												_0: _user$project$Model$NoAction,
												_1: {ctor: '[]'}
											},
											_1: {
												ctor: '::',
														...
														_1: {
															...
															_0: A8(
																...
																'EditBox test',
																{
																	...
																	_1: {
																		ctor: '::',
																		_0: 'placeholder :) for Text Input should be in options',
																		_1: {ctor: '[]'}
																	}
																},
...
var _user$project$AlertBuilder$viewAlertMsg = function (messageList) {
	var displayMessage = function (message) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(_user$project$CssTranslation$css.flash),
				_1: {
					ctor: '::',
										...
										_1: {
											...
											_0: _elm_lang$html$Html_Events$onClick(
												_elm_lang$core$List$singleton(
													_user$project$Model$ClearAlert(message))),
											_1: {ctor: '[]'}
										}
									}
								}
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('alerts'),
			_1: {ctor: '[]'}
		},
		A2(_elm_lang$core$List$map, displayMessage, messageList));
};
...
var _user$project$CheckBoxBuilder$optionNameToOrdinal = F2(
...
var _user$project$CheckBoxBuilder$orderToActions = F2(
	function (actions, $int) {
		return A2(
			...
			A2(
				...
				$int,
				_elm_lang$core$Array$fromList(actions)));
	});
var _user$project$CheckBoxBuilder$listOfCheckBoxes = function (question) {
	var orderToTwoActions = function (num) {
		return A2(
			...
			A2(
				...
				_user$project$CheckBoxBuilder$orderToActions(question.actions),
				{
					ctor: '::',
					_0: num,
					_1: {
		...
		return orderToTwoActions(
			A2(
				...
				A2(
					_elm_lang$core$Maybe$withDefault,
					0,
					A2(_user$project$CheckBoxBuilder$optionNameToOrdinal, optionName, question.options))));
	};
	var onCheckFn = F2(
	...
	var checkBoxItem = function (optionName) {
		var ordinal = A2(_user$project$CheckBoxBuilder$optionNameToOrdinal, optionName, question.options);
		var idOfCheck = A2(_user$project$CheckBoxBuilder$appendNumberToBeginningOfString, optionName, ordinal);
		return A2(
			...
			},
			{
				...
				_0: A2(
					_elm_lang$html$Html$input,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$id(idOfCheck),
							_1: {
								ctor: '::',
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class(_user$project$CssTranslation$css.form_check_input),
									_1: {ctor: '[]'}
								}
							}
						}
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class(_user$project$CssTranslation$css.form_check_label),
							_1: {
								ctor: '::',
								_0: A2(_elm_lang$html$Html_Attributes$attribute, 'for', idOfCheck),
								_1: {ctor: '[]'}
							}
						},
						{
	...
	return A2(_elm_lang$core$List$map, checkBoxItem, question.options);
};
var _user$project$CheckBoxBuilder$listQuestionTextItems = function (questionText) {
	...
	return A2(_elm_lang$core$List$map, listItem, questionText);
};
var _user$project$CheckBoxBuilder$buildCheckboxQuestion = function (question) {
	var description = A2(
		_elm_lang$core$Maybe$withDefault,
		'',
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('checkbox-question'),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html_Attributes$attribute,
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class(_user$project$CssTranslation$css.form_check),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class(_user$project$CssTranslation$css.unstiled_list),
										_1: {ctor: '[]'}
									},
									_user$project$CheckBoxBuilder$listOfCheckBoxes(question)),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$ul,
								{ctor: '[]'},
								_user$project$CheckBoxBuilder$listQuestionTextItems(
...
var _user$project$DropDownBuilder$buildDropDownQuestion = function (question) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class(_user$project$CssTranslation$css.question),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$label,
				{
					...
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$html$Html_Attributes$attribute, 'for', question.title),
						_1: {ctor: '[]'}
					}
				},
				{
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class(_user$project$CssTranslation$css.select),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$id(question.title),
								_1: {
									ctor: '::',
									_0: A2(_elm_lang$html$Html_Events$on, 'change', valueDecoder),
									_1: {ctor: '[]'}
								}
							}
						},
...
var _user$project$EditBoxBuilder$buildTextAreaQuestion = F2(
	function (areaOnly, question) {
		var boxOrArea = function (areaOnlyBool) {
			return areaOnlyBool ? A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
				{ctor: '[]'}) : A2(
				_elm_lang$html$Html$button,
				{
					...
					_0: _elm_lang$html$Html_Attributes$class(
						A2(_elm_lang$core$Basics_ops['++'], _user$project$CssTranslation$css.edit_button_class, ' test')),
					_1: {
						ctor: '::',
						...
						_1: {
							...
							_0: _elm_lang$html$Html_Events$onClick(
								_elm_lang$core$List$singleton(
									_user$project$Model$StopEdit(question.uuid))),
							_1: {ctor: '[]'}
						}
					}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(_user$project$CssTranslation$css.done_button),
					_1: {ctor: '[]'}
				});
		};
					...
					_1: {
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('edit-box'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class(_user$project$CssTranslation$css.form_control),
											_1: {
												ctor: '::',
												_0: A2(_elm_lang$html$Html_Attributes$attribute, 'rows', '10'),
												_1: {
													ctor: '::',
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onInput(onInputFn),
															_1: {ctor: '[]'}
														}
													}
												}
										...
										_user$project$EditBoxBuilder$buildAreaText(question.options)),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _user$project$EditBoxBuilder$buildContentParrographs = function (stringList) {
	return A2(
		_elm_lang$core$List$map,
		function (x) {
			return A2(
...
var _user$project$EditBoxBuilder$buildEditBoxQuestion = function (question) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class(_user$project$CssTranslation$css.edit_button_class),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$type_('button'),
										_1: {
											...
											_0: _elm_lang$html$Html_Events$onClick(
												_elm_lang$core$List$singleton(
													_user$project$Model$StartEdit(question.uuid))),
											_1: {ctor: '[]'}
										}
									}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(_user$project$CssTranslation$css.edit_button),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('edit-content'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$style(
												{
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'border', _1: 'thin dashed black'},
													_1: {
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'padding', _1: '1rem'},
														_1: {ctor: '[]'}
...
var _user$project$JsonImporter$questionTypeDecoder = function (string) {
	var _p1 = _elm_lang$core$String$toLower(string);
	switch (_p1) {
		case 'checkbox':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model$CheckBox);
		case 'radio':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model$RadioButton);
		case 'dropdown':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model$DropDown);
		case 'markdown':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model$Markdown);
		case 'editbox':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model$EditBox);
		case 'textbox':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model$TextBox);
		case 'textinput':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model$TextInput);
		case 'textarea':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model$TextArea);
		case 'table':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model$Table);
		case 'button':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model$Button);
		case 'subheading':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model$SubHeading);
		case 'notaquestion':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model$NotAQuestion);
		default:
			return _elm_lang$core$Json_Decode$fail(
				A2(
					_elm_lang$core$Basics_ops['++'],
					'Value ',
					A2(_elm_lang$core$Basics_ops['++'], string, 'Is not a question type.')));
	}
};
			...
			switch (_p2) {
				case 'addquestion':
					return _elm_lang$core$Json_Decode$succeed(
						_user$project$Model$AddQuestion(number));
				case 'removequestion':
					return _elm_lang$core$Json_Decode$succeed(
						_user$project$Model$RmQuestion(number));
...
var _user$project$JsonImporter$decodeQuestion = A4(
	...
	A4(
		...
		_elm_lang$core$Json_Decode$list(
			_elm_lang$core$Json_Decode$list(_user$project$JsonImporter$decodeAction)),
		{ctor: '[]'},
		A4(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
			'options',
			...
			A4(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
				'saveAction',
				A2(_elm_lang$core$Json_Decode$andThen, _user$project$JsonImporter$decodeSaveAction, _elm_lang$core$Json_Decode$string),
				_user$project$Model$None,
				A3(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
					'type',
					A2(_elm_lang$core$Json_Decode$andThen, _user$project$JsonImporter$questionTypeDecoder, _elm_lang$core$Json_Decode$string),
					A4(
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
						'text',
						_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string),
						...
						A3(
							...
							A3(
								...
								'uid',
								_elm_lang$core$Json_Decode$int,
								_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model$QuestionRecord)))))))));
var _user$project$JsonImporter$decodeListOfQuestions = _elm_lang$core$Json_Decode$list(_user$project$JsonImporter$decodeQuestion);
var _user$project$JsonImporter$importQuestionInPage = function (jsonString) {
	return A2(
...
var _user$project$MarkdownBuilder$buildMarkdown = function (question) {
	return A3(
		_evancz$elm_markdown$Markdown$toHtmlWith,
		_user$project$MarkdownBuilder$options,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class(_user$project$CssTranslation$css.markdown_class),
			_1: {ctor: '[]'}
		},
		A3(
			_elm_lang$core$List$foldr,
...
var _user$project$RadioButtonBuilder$listOfRadioButtons = function (question) {
	...
	var radioButton = F2(
		function (index, optionName) {
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class(_user$project$CssTranslation$css.list_radio),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$id(optionName),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$name(question.title),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value(optionName),
										_1: {
											ctor: '::',
											_0: A2(_elm_lang$html$Html_Events$on, 'change', valueDecoder),
											_1: {ctor: '[]'}
	...
	return A2(_elm_lang$core$List$indexedMap, radioButton, question.options);
};
var _user$project$RadioButtonBuilder$buildRadioButtonQuestion = function (question) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class(_user$project$CssTranslation$css.radiobuttons),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html_Attributes$attribute,
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class(_user$project$CssTranslation$css.fieldset_inputs),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class(_user$project$CssTranslation$css.legend),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class(_user$project$CssTranslation$css.custom_radio),
											_1: {ctor: '[]'}
										},
										_user$project$RadioButtonBuilder$listOfRadioButtons(question)),
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
	...
	switch (_p0.ctor) {
		...
		default:
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('No QuestionType Error'),
					_1: {ctor: '[]'}
				});
	}
};
var _user$project$View$viewQuestionList = F2(
	function (allQuestions, questions) {
		var partialQuestions = A2(
			_elm_lang$core$List$filter,
			function (q) {
				return A2(_elm_lang$core$List$member, q.uuid, questions);
			},
			allQuestions);
		return A2(
			_elm_lang$core$List$map,
				...
				A2(
					...
					function (i) {
						return A2(
							_elm_lang$core$List$filter,
							function (q) {
								return _elm_lang$core$Native_Utils.eq(q.uuid, i);
							},
							partialQuestions);
					},
					questions)));
	});
var _user$project$View$viewFooter = A2(
	...
	{ctor: '[]'},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$href('https://www.github.com/rebelwarrior'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _user$project$View$viewH1 = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class(_user$project$CssTranslation$css.header),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
...
var _user$project$View$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class(_user$project$CssTranslation$css.grid),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _user$project$AlertBuilder$buildAlerts(model.alertMessages),
			_1: {
				ctor: '::',
				_0: _user$project$View$viewH1,
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class(_user$project$CssTranslation$css.subgrid),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
					...
					_1: {
						ctor: '::',
						_0: _user$project$View$viewFooter,
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Main$processFlags = function (flag) {
	var captureError = function (result) {
		...
		if (_p0.ctor === 'Ok') {
			...
			return _elm_lang$core$List$singleton(_p0._0);
		}
	};
	var listOfQuestionsResult = _user$project$JsonImporter$importQuestionsJson(flag.q);
	var initialQuestionsList = A2(
		_elm_lang$core$Result$withDefault,
		{ctor: '[]'},
		listOfQuestionsResult);
	var listOfQuestionsOnPageResult = _user$project$JsonImporter$importQuestionInPage(flag.l);
	var initialAlerts = _elm_lang$core$List$concat(
		{
			ctor: '::',
			_0: captureError(listOfQuestionsResult),
			_1: {
				ctor: '::',
				_0: captureError(listOfQuestionsOnPageResult),
				_1: {ctor: '[]'}
			}
		});
	var initialQuestionsInPage = A2(
		_elm_lang$core$Result$withDefault,
		{ctor: '[]'},
